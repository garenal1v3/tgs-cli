...
Возвращает JSON с массивом записей по датам. Каждая запись содержит дату, количество совпавших сообщений за этот день и диапазон ID сообщений (`min_msg_id`, `max_msg_id`).
